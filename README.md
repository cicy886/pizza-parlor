...
#### By Sisi Vieira
## Discription
This project includes one HTML file, one custom CSS file, one custom JS file, bootstrap.css, jquery-3.6.0.js, and one MD file. The purpose of this webpage is to allow the user to design their own pizza and edit the total price, based on their topping and size selections. You can add more content to the HTML file, the CSS file can decorate the webpage, and the JS file can make the webpage interactive with users.
...
## Known Bugs
The total payment is not displaying correctly.
## Github page website
